 ...
 */
final class Version20210426094258 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conges (id INT AUTO_INCREMENT NOT NULL, date_demande DATE NOT NULL, date_depart DATE NOT NULL, date_retour DATE NOT NULL, motif VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
